        ...
        >
          <Animated.View
            style={{
              alignItems: "center",
              transform: [
                { scale: iconAnim.home.interpolate({ inputRange: [0, 1], outputRange: [1, 1.08] }) },
                { translateY: iconAnim.home.interpolate({ inputRange: [0, 1], outputRange: [0, -1] }) },
              ],
            }}
          >
            <MaterialIcons
        ...
        >
          <Animated.View
            style={{
              alignItems: "center",
              transform: [
                { scale: iconAnim.grievance.interpolate({ inputRange: [0, 1], outputRange: [1, 1.08] }) },
                { translateY: iconAnim.grievance.interpolate({ inputRange: [0, 1], outputRange: [0, -1] }) },
              ],
            }}
          >
            <MaterialIcons
        ...
        >
          <Animated.View
            style={{
              alignItems: "center",
              transform: [
                { scale: iconAnim.feed.interpolate({ inputRange: [0, 1], outputRange: [1, 1.08] }) },
                { translateY: iconAnim.feed.interpolate({ inputRange: [0, 1], outputRange: [0, -1] }) },
              ],
            }}
          >
            <MaterialIcons
        ...
        >
          <Animated.View
            style={{
              alignItems: "center",
              transform: [
                { scale: iconAnim.profile.interpolate({ inputRange: [0, 1], outputRange: [1, 1.08] }) },
                { translateY: iconAnim.profile.interpolate({ inputRange: [0, 1], outputRange: [0, -1] }) },
              ],
            }}
          >
            <MaterialIcons
